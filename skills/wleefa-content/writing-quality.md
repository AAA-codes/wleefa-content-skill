These are the no-ai-slop rules, carried into the Wleefa skill unchanged apart from headings. Apply them after the Wleefa rules in SKILL.md.
...
## Two jobs (as used inside wleefa-content)
...
4. For an edit, make the minimum effective changes, then check the edited draft against the wleefa-content `eval.md` yourself.
